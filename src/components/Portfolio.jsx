...
const projects = [
  { id: 1, title: "Clubbera", description: "Ready to break free from the virtual world and make some real-life connections? Clubbera is here to help you do just that! This platform is all about bringing people together through shared interests and unforgettable experiences.", image: "/clubbera.jpg", link: "https://clubbera.com/", tech: ["Nextjs", "Node.js", "MongoDB"] },
  // { id: 2, title: "Monirates", description: "Monirates is a fintech web app and mobile app. With Monirates, you can move, send, and receive money effortlessly, conduct business seamlessly across Africa, and pay tuition fees globally—all within a single, convenient platform.", image: "/monirates.png", link: "https://monirates.com/", tech: ["ReactJs", "React native", "Node.js", "MongoDB", "MySQL", "Rest APIs"] },
  { id: 2, title: "Prime Edge", description: "Prime Edge is a partnership-driven real estate development company built on discipline, clarity, and long-term value creation. They specialise in structuring, developing, and delivering premium residential and commercial projects through joint ventures with landowners, investors, and institutional partners.", image: "/primeedge.png", link: "https://primeedgeco.com/", tech: ["NextJs", "Node.js", "MongoDB", "Rest APIs"] },
  { id: 3, title: "Wig'd By Dee", description: "At Wig'd By Dee, we believe that a great wig isn't just hair — it's an expression of who you are. Based in the heart of Lekki Phase 1, Lagos, we provide expert wig services that blend artistry with precision, tailored to bring out your most radiant self.", image: "/dee.png", link: "https://wigedbydee.vercel.app/", tech: ["ReactJs"] },
  { id: 4, title: "Lagos Diocese Youth", description: "This is a website designed for the Anglican Communion Diocese of Lagos youth. It is a work in progress and it has 2025 camp registration link that is still in progress.", image: "/anglican.jpg", link: "https://www.dioceseoflagosyouths.com/", tech: ["React", "Tailwind CSS"] },
  { id: 5, title: "Furniro", description: "Funiro is more than just an online store for furnitures. They are passionate about bringing you handcrafted furniture and decor that are both functional and beautiful", image: "/furniro.jpg", link: "https://furniro-iota-eight.vercel.app/", tech: ["React", "E-commerce"] },
  { id: 6, title: "Scupay", description: "A payment management solution for schools. Scupay is a payment solution designed to streamline payment management for educational institutions", image: "/scupay.jpg", link: "https://scupay-new.vercel.app/", tech: ["React", "Payment API"] },
  { id: 7, title: "Portfolio", description: "This is a simple yet modern and beautiful portfolio built for a cinematographer and photographer", image: "/esther.jpg", link: "https://estheramahero.netlify.app/", tech: ["React", "Framer Motion"] },
  { id: 8, title: "Geodex", description: "Geodex is a web application that connects brands to outdoor advertising through innovative tech, data scientists, marketers, and media experts.", image: "/geodex.jpg", link: "https://geodex.tech/", tech: ["React", "Maps API"] },
  { id: 9, title: "Shopify Replica", description: "This is a simple yet modern and beautiful replica of the Shopify app. (e-commerce)", image: "/shopify.jpg", link: "https://shofy-beauty-and-cosmetics-ecommerce-client-eight.vercel.app/", tech: ["React", "E-commerce"] },
  { id: 10, title: "Tugro Cargo Group", description: "This is a representative logistics operator providing full range of service in the sphere of customs clearance and transport worldwide for any type of cargo.", image: "/cargo.jpg", link: "https://tugrocargo.online/", tech: ["React", "Logistics"] },
  { id: 11, title: "Pinnacle Homes & Autos", description: "This is more than just an online marketplace. They bring you a premium selection of high-quality vehicles and beautiful homes that reflect both style and reliability", image: "/pinnacle.jpg", link: "https://pinnacle-red.vercel.app/", tech: ["React", "Marketplace"] },
];
